...
__all__ = ['YouTubeDatabs4API']

class YouTubeDatabs4API(YouTubeDataAPI):
    """
    The Youtube Data bs4API handles the methods to access data from a bs4 based emulation of the YouTube Data API
    """
    def __init__(
        self, api_version='3', verbose=False, timeout=20
    ):
